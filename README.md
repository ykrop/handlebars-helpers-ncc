...
* **[logging](#logging)** ([code](lib/logging.js) | [unit tests](test/logging.js)) - Currently disabled
...
* **[misc](#misc)** ([code](lib/misc.js) | [unit tests](test/misc.js)) - Currently disabled
...
### [logging helpers](#logging) - Currently disabled
...
### [misc helpers](#misc) - Currently disabled
